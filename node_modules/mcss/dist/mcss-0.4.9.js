...
(function (modules) {
        ...
        Parser.prototype = {
            ...
            logicAndExpr: function () {
                ...
                while ((la = this.la()) === '&&') {
                    ...
                    if (!right)
                        this.error(la + ' require right operand', node);
    ...
    '9': function (require, module, exports, global) {
        ...
        Color.limit = function (values) {
            ...
            if (values.alpha)
                values.alpha = _.limit(values.alpha, 0, 1);
        };
    ...
    'h': function (require, module, exports, global) {
        var _ = require('4');
        module.exports = { remoteFileCache: _.cache(40) };
    },
    ...
    'j': function (require, module, exports, global) {
        var Interpreter = require('k');
        module.exports = Interpreter;
    },
    'k': function (require, module, exports, global) {
        var Walker = require('l');
        var parser = require('2');
        var tree = require('8');
        var symtab = require('g');
        var state = require('m');
    ...
    'o': function (require, module, exports, global) {
        ...
        var _ = module.exports = {
                ...
                hsla: u.accept(function (h, s, l, a) {
                    ...
                    if (s.unit !== '%' || l.unit !== '%')
                        this.error('hsl param saturation and light all only accept percent');
                    if (a && a.unit === '%')
                        a.value /= 100;
                    var node = Color.hsl([
                            h.value,
                ...
                match: u.accept(function (reg, str) {
                    if (!str || str.type !== 'STRING' && str.type !== 'TEXT')
                        return false;
                    var testReg = new RegExp(reg.value), strValue = str.value || '';
        ...
        _['-adjust'] = u.accept(function (color, prop, weight, absolute) {
            ...
            if (isRGBA(p)) {
                ...
                if (weight.unit)
                    this.error('rgba adjust only accept NUMBER');
    ...
    'x': function (require, module, exports, global) {
        var _ = require('4'), options = require('f'), Event = require('n'), fs = null;
