...
},{"./app.js":33,"stateman":28}],2:[function(require,module,exports){
...
},{"./config.js":3,"./dom.js":8,"./env.js":9,"./group.js":10,"./helper/combine.js":12,"./helper/event.js":14,"./helper/extend.js":15,"./helper/parse.js":16,"./helper/watcher.js":18,"./parser/Lexer.js":21,"./parser/Parser.js":22,"./util":24,"./walkers.js":25}],3:[function(require,module,exports){
...
},{"../Regular.js":2,"../dom.js":8,"../helper/animate.js":11,"../util.js":24}],5:[function(require,module,exports){
// Regular
...
},{"../Regular.js":2,"../dom.js":8,"../helper/animate.js":11,"../util.js":24,"./event.js":6,"./form.js":7}],6:[function(require,module,exports){
/**
...
},{"../Regular.js":2,"../dom.js":8,"../util.js":24}],7:[function(require,module,exports){
// Regular
var _ = require("../util.js");
var dom = require("../dom.js");
var Regular = require("../Regular.js");
...
},{"../Regular.js":2,"../dom.js":8,"../util.js":24}],8:[function(require,module,exports){
...
},{"./env.js":9,"./util":24}],9:[function(require,module,exports){
// some fixture test;
// ---------------
var _ = require('./util');
...
},{"./helper/combine":12,"./util":24}],11:[function(require,module,exports){
var _ = require("../util");
var dom  = require("../dom.js");
var animate = {};
var env = require("../env.js");
...
},{"../dom.js":8,"../env.js":9,"../util":24}],12:[function(require,module,exports){
...
},{"../util.js":24}],15:[function(require,module,exports){
...
},{"../util.js":24}],16:[function(require,module,exports){
...
},{"../env":9,"../parser/Parser.js":22,"../util":24}],17:[function(require,module,exports){
// shim for es5
var slice = [].slice;
var tstr = ({}).toString;
...
},{"../util.js":24,"./parse.js":16}],19:[function(require,module,exports){
...
},{"./Regular.js":2,"./directive/animation.js":4,"./directive/base.js":5,"./dom.js":8,"./env.js":9,"./module/timeout.js":20,"./util.js":24}],20:[function(require,module,exports){
var Regular = require("../Regular.js");
...
},{"../Regular.js":2}],21:[function(require,module,exports){
var _ = require("../util.js");
var config = require("../config.js");
...
},{"../config.js":3,"../util.js":24}],22:[function(require,module,exports){
var _ = require("../util.js");
...
},{"../config.js":3,"../util.js":24,"./Lexer.js":21,"./node.js":23}],23:[function(require,module,exports){
module.exports = {
...
},{"./helper/entities.js":13,"./helper/shim.js":17}],25:[function(require,module,exports){
...
},{"./dom.js":8,"./group.js":10,"./helper/animate.js":11,"./helper/combine.js":12,"./parser/node.js":23,"./util":24}],26:[function(require,module,exports){
...
module.exports=[{"type":"element","tag":"input","attrs":[{"type":"attribute","name":"type","value":"text"},{"type":"attribute","name":"r-model","value":{"type":"expression","body":"_c_._sg_('stateName', _d_['stateName'])","constant":false,"setbody":"_c_._ss_('stateName',_p_,_d_, '=')"}},{"type":"attribute","name":"on-enter","value":{"type":"expression","body":"_c_['addState'](_c_._sg_('stateName', _d_['stateName']))","constant":false,"setbody":false}}]},{"type":"text","text":"\n"},{"type":"element","tag":"a","attrs":[{"type":"attribute","name":"href","value":"#"},{"type":"attribute","name":"on-click","value":{"type":"expression","body":"_c_['addState'](_c_._sg_('stateName', _d_['stateName']))","constant":false,"setbody":false}}],"children":[{"type":"text","text":"Add a state"}]},{"type":"text","text":"\n\n"},{"type":"element","tag":"ul","attrs":[],"children":[{"type":"text","text":"\n  "},{"type":"element","tag":"li","attrs":[],"children":[{"type":"text","text":"current: "},{"type":"expression","body":"_c_._sg_('state', _d_['state'])['current']['name']","constant":false,"setbody":"_c_._sg_('state', _d_['state'])['current']['name']=_p_"}]},{"type":"text","text":"\n  "},{"type":"element","tag":"li","attrs":[],"children":[{"type":"text","text":"pending: "},{"type":"expression","body":"_c_._sg_('state', _d_['state'])['pending']['name']","constant":false,"setbody":"_c_._sg_('state', _d_['state'])['pending']['name']=_p_"}]},{"type":"text","text":"\n  "},{"type":"element","tag":"li","attrs":[],"children":[{"type":"text","text":"previous: "},{"type":"expression","body":"_c_._sg_('state', _d_['state'])['previous']&&_c_._sg_('state', _d_['state'])['previous']['name']","constant":false,"setbody":false}]},{"type":"text","text":"\n"}]},{"type":"text","text":"\n\n\n"},{"type":"element","tag":"state","attrs":[{"type":"attribute","name":"state","value":{"type":"expression","body":"_c_._sg_('state', _d_['state'])","constant":false,"setbody":"_c_._ss_('state',_p_,_d_, '=')"}}],"children":[]}]
...
},{"./app.html":32,"./state.js":35,"regularjs":19}],34:[function(require,module,exports){
module.exports=[{"type":"element","tag":"div","attrs":[{"type":"attribute","name":"class","value":"state"},{"type":"attribute","name":"r-class","value":{"type":"expression","body":"{'z-last':(!_c_._sg_('state', _d_['state'])['hasNext']),'z-current':_c_._sg_('actived', _d_['actived'])}","constant":false,"setbody":false}},{"type":"attribute","name":"r-animation","value":"\n  on:enter; class: animated bounceIn; \n  on:leave; class: animated bouceOut;\n  "},{"type":"if","test":{"type":"expression","body":"(!_c_._sg_('state', _d_['state'])['hasNext'])","constant":false,"setbody":false},"consequent":[[{"type":"attribute","name":"on-click","value":{"type":"expression","body":"_c_._sg_('state', _d_['state'])['manager']['go'](_c_._sg_('state', _d_['state']))","constant":false,"setbody":false}}]],"alternate":[]}],"children":[{"type":"text","text":"\n  "},{"type":"element","tag":"header","attrs":[{"type":"attribute","name":"class","value":"hd"}],"children":[{"type":"expression","body":"_c_._sg_('state', _d_['state'])['name']||'Root'","constant":false,"setbody":false},{"type":"text","text":" "}]},{"type":"text","text":"\n\n  "},{"type":"element","tag":"div","attrs":[{"type":"attribute","name":"class","value":"cnt"}],"children":[{"type":"text","text":"\n    "},{"type":"if","test":{"type":"expression","body":"_c_._sg_('state', _d_['state'])['hasNext']","constant":false,"setbody":"_c_._sg_('state', _d_['state'])['hasNext']=_p_"},"consequent":[{"type":"text","text":"\n      "},{"type":"list","sequence":{"type":"expression","body":"Object['keys'](_c_._sg_('state', _d_['state'])['_states'])","constant":false,"setbody":false},"variable":"st","body":[{"type":"text","text":"\n        "},{"type":"element","tag":"state","attrs":[{"type":"attribute","name":"state","value":{"type":"expression","body":"_c_._sg_('state', _d_['state'])['state'](_c_._sg_('st', _d_['st']))","constant":false,"setbody":false}}]},{"type":"text","text":"\n      "}]},{"type":"text","text":"\n    "}],"alternate":[]},{"type":"text","text":"\n  "}]},{"type":"text","text":"\n"}]}]
