 ...
 */
declare type StringResult = string | (()=>string);

/*
 Parameter for Stateman constructor
 */
declare interface StatemanCtorOptions
{
    /*
 ...
 */
declare interface RoutingOption
{
    /*
...
declare type StateOptionHandler = (option:RoutingOption)=> (void | boolean | Promise);

declare interface StateOptionObject
{
...
declare type StateConfig = StateOptionObject | StateOptionHandler | string;

declare interface StatemanStartOptions
{
    /*
 ...
 */
declare interface StatemanNavOptions
{
    /*
...
declare class State
{
    ...
    state(stateName:string, config:StateOptionObject):State;
 ...
 */
declare class Stateman // extends State
{
    /*
     ...
     */
    state(states:{[stateName:string]:StateConfig}):Stateman;
